...
namespace BiRD
{
    public class ScreenRecorder
    {
        ...
        public int PackagePerTimeout { get; set; } = 15;

        public event FrameCaptureHandler FrameCaptured;
        public delegate void FrameCaptureHandler(Bitmap bitmap);
        ...
        public ScreenRecorder(IPAddress remoteIp)
        {
        ...
        public void SendByteStream(byte[][] chunks, int dataLen, int imageWidth, int imageHeight, string ip, int port)
        {
        ...
        public int GetPercentage()
        {
            ...
            Application.Current.Dispatcher.Invoke(
                ...
                (ThreadStart)delegate { progress = (int)PackagePerTimeout; }
            );
        ...
        public void RecordScreen()
        {
            while (loop)
            {
                ...
                if (RemoteIp == null) throw new NullReferenceException($"Variable {nameof(RemoteIp)} is null.");
                SendByteStream(chunks, bitByte.Length, bitmap.Width, bitmap.Height, RemoteIp.ToString(), 11000); //"10.142.112.247"
